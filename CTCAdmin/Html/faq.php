<?php  
 ...
 $faq_qry = ('SELECT * FROM faq f INNER JOIN userreg u ON f.userid= u.id INNER JOIN itemproducts i ON i.item_id = f.itemid');
 $squery = mysqli_query($mysqli,$faq_qry);
...
<div class="container-fluid" style="background-color: #31313148;"><h1 align="center"></i>
              <span><font color="#fff"><b>FAQ</b></font></span></h1> </div>
                 ...
                 <?php
                          ...
                          {  
                               ...
                               <tr> 
                                    ...
                                    <td>'.$row["msg"].'</td>  
                                    <td>'.$row["reply"].'</td>
                                    <td><center><button type="button" class="btn btn-info" data-toggle="modal" data-target="#message'.$row['cid'].'">Reply</button></center></td>
                                    <div id="message'.$row['cid'].'" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <form method="post" action="faqreply.php">
      ...
      <div class="modal-footer">
        <button type="submit" name="addreply" class="btn btn-primary">Save</button>
