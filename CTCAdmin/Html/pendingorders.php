        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            <a href="javascript:;">
              ...
              <li><a href="allitems.php"><i class="fa fa-eye"></i><span> Update Items</span></a></li>
...
<div class="container-fluid" style="background-color: #31313148;"><h3 align="center"><font color="#fff"><b>Pending Orders</b></font></h3> </div>
